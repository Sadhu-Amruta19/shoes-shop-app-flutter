...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: IndexedStack(
        // give index to screen whatever screen we stoped again get that.
        index: currentPage,
        children: pages,
      ),
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
            ...
            label:
                '', // when you use BottomNavigationBarItem it is necessary to give label it's ok is empty but need to declare atleast.
          ),
          BottomNavigationBarItem(
